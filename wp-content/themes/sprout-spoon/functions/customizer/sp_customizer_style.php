...
function solopine_customizer_css() {
    ...
    <style type="text/css">
		...
		<?php $get_bg_trans = get_theme_mod( 'sprout_spoon_featured_bg_trans' ); if(!$get_bg_trans) { $get_bg_trans = 0.4; } ?>
		<?php $get_bg_trans_hover = get_theme_mod( 'sprout_spoon_featured_bg_trans_hover' ); if(!$get_bg_trans_hover) { $get_bg_trans_hover = 0.72; } ?>
		<?php if(get_theme_mod( 'sprout_spoon_featured_bg' )) : ?>.feat-overlay { background-color:rgba(<?php sprout_spoon_hex2rgb(get_theme_mod( 'sprout_spoon_featured_bg' ), $get_bg_trans); ?>); }<?php endif; ?>
		<?php if(get_theme_mod( 'sprout_spoon_featured_bg' )) : ?>.feat-item:hover .feat-overlay { background-color:rgba(<?php sprout_spoon_hex2rgb(get_theme_mod( 'sprout_spoon_featured_bg' ), $get_bg_trans_hover); ?>); }<?php endif; ?>
		...
		<?php $custom_css = get_theme_mod( 'sprout_spoon_custom_css' ); ?>
		<?php $convert_carrots = str_replace('&gt;','>',$custom_css); ?>
		<?php echo $convert_carrots; ?>
		<?php endif; ?>
