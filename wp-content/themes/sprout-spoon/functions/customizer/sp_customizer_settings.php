...
function solopine_register_theme_customizer( $wp_customize ) {
	...
	// Add Setting
		...
		$wp_customize->add_setting(
	        'sprout_spoon_featured_hide_mobile',
	        array(
	            'default'     => false,
				'sanitize_callback'     => 'solopine_sanitize_checkbox'
	        )
		...
		$wp_customize->add_setting(
	        'sprout_spoon_post_date_updated',
	        array(
	            'default'     => false,
				'sanitize_callback'     => 'solopine_sanitize_checkbox'
	        )
		...
		$wp_customize->add_setting(
	        'sprout_spoon_post_date_under_title',
	        array(
	            'default'     => false,
				'sanitize_callback'     => 'solopine_sanitize_checkbox'
	        )
		...
		$wp_customize->add_setting(
	        ...
	        array(
	            'default'     => esc_html__( 'Copyright 2018 - <a href="http://solopine.com">Solo Pine</a>. All Rights Reserved.', 'sprout-spoon' ),
				'sanitize_callback'     => 'wp_kses_post'
	        )
	    );
		$wp_customize->add_setting(
	...
	// Add Control
		...
		$wp_customize->add_control(
			new WP_Customize_Control(
				$wp_customize,
				'featured_hide_mobile',
				array(
					'label'      => esc_html__( 'Hide Featured Area on Mobile/Tablet devices', 'sprout-spoon' ),
					'section'    => 'solopine_new_section_featured',
					'settings'   => 'sprout_spoon_featured_hide_mobile',
					'type'		 => 'checkbox',
					'priority'	 => 7
				)
			)
		...
		$wp_customize->add_control(
			new WP_Customize_Control(
				...
				'post_date_updated',
				array(
					'label'      => esc_html__( 'Show Last Updated date on post pages', 'sprout-spoon' ),
					'section'    => 'solopine_new_section_post',
					'settings'   => 'sprout_spoon_post_date_updated',
					'type'		 => 'checkbox',
					'priority'	 => 11
				)
			)
		...
		$wp_customize->add_control(
			new WP_Customize_Control(
				$wp_customize,
				'post_date_under_title',
				array(
					'label'      => esc_html__( 'Show Date below title', 'sprout-spoon' ),
					'section'    => 'solopine_new_section_post',
					'settings'   => 'sprout_spoon_post_date_under_title',
					'type'		 => 'checkbox',
					'priority'	 => 12
				)
			)
